...
- **Living queue** — automatic arrival numbering, games played counter, auto-requeue after each game
...
- **Session highlights** — fun stats: most active, win streak, top scorer, social butterfly, rivals
