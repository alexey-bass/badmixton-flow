...
App.i18n = {
  ...
  translations: {
    pl: {
      ...
      syncDesc: 'Sesja synchronizuje się automatycznie. Udostępnij link — każdy kto go ma, może dołączyć i zobaczyć dane.',
      ...
      debugSeedData: 'Dane testowe',
      debugSeedQueue13: 'Kolejka: 13 / 3',
      debugSeedShuffle13: 'Shuffle: 13 / 3',
      debugSeedShuffle20: 'Shuffle: 20 / 5',
      debugSeedConfirm: 'Obecna sesja zostanie usunięta i zastąpiona danymi testowymi. Kontynuować?',
      debugSeedDone: 'Dane testowe załadowane.',
      debugPlayers: 'Graczy',
      ...
      debugMatches: 'Meczów',
      debugCreator: 'Twórca sesji',
      debugCreatorScreen: 'Ekran',
      debugCreatorTime: 'Utworzono',
      ...
      bulkAddShortenNames: 'Skróć „Nazwisko Imię" → „Imię N"',
    ...
    en: {
      ...
      syncDesc: 'Session syncs automatically. Share the link — anyone with it can join and see the data.',
      ...
      debugSeedData: 'Test data',
      debugSeedQueue13: 'Queue: 13 / 3',
      debugSeedShuffle13: 'Shuffle: 13 / 3',
      debugSeedShuffle20: 'Shuffle: 20 / 5',
      debugSeedConfirm: 'Current session will be deleted and replaced with test data. Continue?',
      debugSeedDone: 'Test data loaded.',
      ...
      debugCreator: 'Session creator',
      debugCreatorScreen: 'Screen',
      debugCreatorTime: 'Created',
      ...
      bulkAddShortenNames: 'Shorten "LastName FirstName" → "FirstName L"',
